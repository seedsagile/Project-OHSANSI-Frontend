            ...
            return (
              ...
              >
                ...
                {(['oro', 'plata', 'bronce', 'menciones'] as const).map((field) => {
                  ...
                  // Deshabilitar flecha abajo si está en el mínimo O si ya está parametrizado
                  const isDecrementDisabled = nivelParametrizado || currentValue <= minValue;
                  
                  // Deshabilitar flecha arriba si está en el máximo O si ya está parametrizado
                  const isIncrementDisabled = nivelParametrizado || currentValue >= maxValue;
                    ...
                    <td key={field} className="px-6 py-4 text-center">
                      <div className="flex items-center justify-center gap-1">
                        <button
                          ...
                          className="w-6 h-6 flex items-center justify-center bg-gray-200 hover:bg-gray-300 rounded disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-gray-200"
                        >
