  ...
  .pipe(
    z
      ...
      .refine((val) => !/\d/.test(val), {
        message:
          'El campo Nombre del evaluador contiene caracteres numéricos. Sólo se aceptan letras.',
      })
      .refine((val) => /^[a-zA-ZáéíóúÁÉÍÓÚñÑüÜ\s]+$/.test(val), {
        message:
          'El campo Nombre del evaluador contiene caracteres especiales. Solo se aceptan letras.',
      })
...
export const apellidoSchema = z
  ...
  .pipe(
    z
      ...
      .refine((val) => !/\d/.test(val), {
        message:
          'El campo Apellido del evaluador contiene caracteres numéricos. Sólo se aceptan letras.',
      })
      .refine((val) => /^[a-zA-ZáéíóúÁÉÍÓÚñÑüÜ\s]+$/.test(val), {
        message:
          'El campo Apellido del evaluador contiene caracteres especiales. Solo se aceptan letras.',
      })
      .transform(normalizeText) // Normaliza al guardar
  );
  ...
  .pipe(
    z
      ...
      .refine(
        ...
        {
          message:
            'El campo Carnet de identidad contiene caracteres especiales. Solo se aceptan números y letras ',
        }
      )
