...
export const FormularioDatosEvaluador = forwardRef<
  HTMLInputElement,
  FormularioDatosEvaluadorProps
>(
  (
    {
      gestiones,
    ...
    const disableAllPersonalAndCorreoFields =
      isLoading ||
      isLoadingGestiones ||
      isSubmitting ||
      isReadOnly ||
      !!personaVerificada?.Id_usuario;

    const disablePersonalFields = disableAllPersonalAndCorreoFields;
    const disableCorreoField = disableAllPersonalAndCorreoFields;

    const disableGestionPasada = isLoading || isSubmitting || isLoadingGestiones;
    ...
    const dropdownPlaceholder = useMemo(() => {
      ...
      if (gestiones.length === 0 && esUsuarioExistente)
        return 'No participó en gestiones anteriores';
      
      return '-- Seleccione Gestión (Opcional) --';
    }, [isLoadingGestiones, gestiones, esUsuarioExistente]);
    ...
    return (
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <User
                  size={16}
                  className="absolute left-3 top-1/2 -translate-y-1/2 text-neutro-400 pointer-events-none"
                  aria-hidden="true"
                />
                <input
                  ref={nombresRef}
                ...
                {esUsuarioExistente && (
                  <span
                    title="Campo pre-rellenado (no editable)"
              ...
              {errors.nombres?.message && (
                <p id="nombres-error" role="alert" className="mt-1 text-xs text-acento-600">
                  {errors.nombres.message}
                </p>
              )}
            </div>
            ...
            <div>
              <label
                htmlFor="apellidos"
                className="block text-sm font-medium text-neutro-700 mb-1"
              >
              ...
              {errors.apellidos?.message && (
                <p id="apellidos-error" role="alert" className="mt-1 text-xs text-acento-600">
                  {errors.apellidos.message}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  aria-describedby={
                    errors.correo ? 'correo-error correo-hint' : 'correo-hint'
                  }
                  {...correoRegisterProps}
                />
                {esUsuarioExistente && (
              ...
              {errors.correo?.message && (
                <p id="correo-error" role="alert" className="mt-1 text-xs text-acento-600">
                  {errors.correo.message}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  aria-describedby={
                    errors.celular ? 'celular-error celular-hint' : 'celular-hint'
                  }
                  {...register('celular')}
                />
                {esUsuarioExistente && (
              ...
              {errors.celular?.message && (
                <p id="celular-error" role="alert" className="mt-1 text-xs text-acento-600">
                  {errors.celular.message}
                </p>
              )}
            </div>
        ...
        {esUsuarioExistente && !isAssignedToCurrentGestion && (
          <fieldset className="space-y-4 border border-neutro-200 p-4 rounded-lg">
            <legend className="text-lg font-semibold text-neutro-800 px-2">
            ...
            <div className="relative">
              <label
                htmlFor="gestionPasadaId-dropdown"
                className="block text-sm font-medium text-neutro-700 mb-1"
              >
